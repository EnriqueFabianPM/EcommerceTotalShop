        ...
        <div>
            <section className="text-gray-600 body-font mb-10">
                ...
                <div className="container px-5 py-10 mx-auto">
                    {/* Heading  */}
                    <h1 className=' text-center text-3xl font-bold text-black' >Testimonial de Compradores</h1>
                    {/* para  */}
                    <h2 className=' text-center text-2xl font-semibold mb-10' >Lo que nuestros <span className=' text-pink-500'>clientes</span> dicen de nosotros</h2>
